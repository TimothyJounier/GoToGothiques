      ...
      <div class="col-md-9">
        <div class="contact-form">
          <div class="form-group">
            <label class="control-label col-sm-2" for="title">Nouveau <br>Titre</label>
            <div class="col-sm-10">   
          ...
          <div class="form-group">
            <label class="control-label col-sm-2" for="date">Nouvelle <br>Date & Heure</label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="control-label col-sm-2" for="description">Nouvelle Description</label>
            <div class="col-sm-10">
